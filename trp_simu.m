% Нужно сделать:
% 1. Добавить возможность внесения возмущения через отклонение входов и
% переменных состояния референсного генератора
...
x0(8) = 0.5; % вносим отклонение переменных состояния
...
% K_u = 1; % амплитуда возмущающего воздействия (управление)
...
% % u_1 = zeros(1,t_size); % отклонение механической мощности на роторе генератора № ng
% % u_2 = zeros(1,t_size); % отклонение напряжения обмотки возбуждения генератора № ng
...
% 
% % возмущение скачком механической мощности на величину K_u в
% % промежутке времени от t1 до t2
% u_1 = zeros(1,t_size); % отклонение механической мощности на роторе генератора № ng
% t1 = 1; % время начала скачка напряжения [с]
% t2 = 2; % время окончания скачка напряжения [с]
